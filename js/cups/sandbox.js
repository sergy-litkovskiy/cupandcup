...
CUPS.Sandbox = function(core, module_selector){
    ...
    var _self = {
        ...
        Order : {
            load : function(orderItemArr, onSuccess, onError) {
                _self.request('/index/ajax_place_order', {order_item_arr: orderItemArr}, onSuccess, onError);
            }
        },
        ...
        Catalog : {
            addOrUpdate : function(data, onSuccess, onError) {
                _self.request('/admin/index_admin/ajax_catalog_edit', data, onSuccess, onError);
            },
            deleteCatalogItem : function(catalogItemId, onSuccess, onError) {
                _self.request('/admin/index_admin/ajax_catalog_delete_item', {id : catalogItemId}, onSuccess, onError);
            },
            changePositionCatalogItem : function(data, onSuccess, onError) {
                _self.request('/admin/index_admin/ajax_catalog_change_position_item', data, onSuccess, onError);
            },
            uploadFile : function(formInJson, onSuccess, onError) {
                _self.request('/admin/index_admin/ajax_catalog_upload_file', formInJson, onSuccess, onError);
            },
            changeStatusCatalogItem : function(data, onSuccess, onError) {
                _self.request('/admin/index_admin/ajax_catalog_change_status_item', data, onSuccess, onError);
            }
        },         
        Contact : {
            sendMail : function(formData, onSuccess, onError) {
                _self.request('/index/ajax_send_contact_mail', {form_data:formData}, onSuccess, onError);
            }
        },       
        JSON:{

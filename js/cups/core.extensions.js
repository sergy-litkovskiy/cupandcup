...
CUPS.Core.registerExtension('ajax', function(core){
    return {
...
CUPS.Core.registerExtension('dom', function(core){
    return {
...
CUPS.Core.registerExtension('json', function(core){
    return {
...
CUPS.Core.registerExtension('storage', function(core){
    return {
...
CUPS.Core.registerExtension('template', function(core){
    return {
...
CUPS.Core.registerExtension('UI', function(core){
...
CUPS.Core.registerExtension('BoBase', function(core){
...
CUPS.Core.registerExtension('type', function(core){
    return {
        isArr : function (arr) {
